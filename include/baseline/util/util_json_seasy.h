...
/*******************************
	...
	util::json::seasy::Object sub_obj3;
	sub_obj3["sub_obj3 string"] = "whoah, I'm sub_obj3's string. hahaha";
	sub_obj3["sub_obj3 int"] = 31337;

	util::json::seasy::Object sub_obj2;
	sub_obj2["int"] = 1000;
	sub_obj2["bool"] = false;
	sub_obj2["x"] = sub_array;
	sub_obj2["z"] = sub_obj3;

	util::json::seasy::Object obj;
	obj["int"] = 1;
	obj["float"] = 1.1f;
	obj["bool"] = true;
	obj["string"] = "com here often?";
	obj["array"] = a;
	obj["sub_obj2"] = sub_obj2;
	obj["null value"] = util::json::seasy::Value();
	jsonstr = util::json::seasy::Serialize(obj);
	LOG_BASELINE_DEBUG<<"json :"<<jsonstr;

*******************************/

#ifndef BASELINE_UTIL_JSON_SUPER_EASY_H
#define BASELINE_UTIL_JSON_SUPER_EASY_H
